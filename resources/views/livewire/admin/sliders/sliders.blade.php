        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('main.add_slider') }} </h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form>
                    <div class="modal-body pb-1">
                        <div class="mb-3">
                            <label class="form-label">{{ __('main.slider_image') }} </label>
                            <input type="file" class="form-control" wire:model="image"
                                id="proidadd{{ $i }}" />
                            @error('image')
                                <span class="text-danger ">{{ $message }}</span>
                            @enderror
                            <p class="text-sm mt-1 text-secondary">{{ __('main.suggest_resolution_slider') }}</p>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">{{ __('main.name') }} <span class="text-danger">*</span> </label>
                            <input type="text" required class="form-control"
                                placeholder="{{ __('main.enter_slider_name') }}" wire:model="name" />
                            @error('name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <form>
                    <div class="modal-body text-center">
                        <div class="pb-4 pt-3">
                            ...
                            <p class="mb-0 text-sm">{{ __('main.confirm_delete_slider') }}</p>
                        </div>
                    </div>
