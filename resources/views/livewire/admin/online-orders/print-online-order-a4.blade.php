...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="app-assets/css/print.css">
        ...
        <div class="row mb-2 justify-content-between">
            ...
            <div class="col-4">
                <div class="text-right">
                    ...
                    <p class="mb-25">
                        <span class="mr-50">Preferred Delivery :</span>
                        <span>{{ \Carbon\Carbon::parse($invoice->preferred_delivery_time)->format('d/m/Y g:i A') }}</span>
                    </p>
                </div>
            </div>
        </div>
