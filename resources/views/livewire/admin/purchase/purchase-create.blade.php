    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="row gx-3 mb-3 align-items-center">
                <div class="col">
                    <h5 class="mb-0">{{ __('main.add_purchase') }}</h5>
                </div>
                <div class="col-auto">
                                                ...
                                                <td class="w-table-15">
                                                    <div class="input-group">
                                                        <input class="form-control input-sm-2" type="number"
                                                            placeholder="Enter Value" value="{{ $quantity[$key] }}"
                    ...
                    <form>
                        <div class="modal-body">
                            <div class="row align-items-start g-3">
                                ...
                                <div class="col-lg-12 col-12">
                                    <div class="mb-0">
                                        <label class="form-label">{{ __('main.phone_number') }}
                                            <span class="text-danger">*</span> </label>
                                        <div class="input-group">
                                ...
                                <div class="col-lg-12 col-12">
                                    <div class="mb-0">
                                        <label
                                            class="form-label">{{ __('main.tax_number') }}</label>
                                        <input type="text" class="form-control"
        ...
        <div class="modal fade" id="confirmpurchase" tabindex="-1" role="dialog" aria-hidden="true"
            wire:ignore.self>
