    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="row gx-3 mb-3 align-items-center">
                <div class="col">
                    <h5 class="mb-0">{{__('main.edit_stock_transfer')}}</h5>
                </div>
                <div class="col-auto">
                                ...
                                <div class="row g-3 mb-0">
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <div class="dropdown-menu show" id="dropmenuMaterial" wire:ignore.self>
                                    ...
                                    <div class="col-lg-2">
                                        <select wire:model="branch_id" class="form-select">
                                            <option value="">{{ __('main.select_a_branch') }}</option>
                                    ...
                                    <div class="col-lg-2">
                                        <input class="form-control digits" required type="date"  wire:model="date"/>
                                        @error('date')
                                        <span class="text-danger">{{$message}}</span>
                                         @enderror
                                    </div>
                                ...
                                <table class="table">
                                    <thead class="bg-light">
                                        <tr>
                                            ...
                                            <th class="text-primary w-table-50"  scope="col">{{ __('main.materials') }}</th>
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-table-20">
                                                <div class="input-group">
                                                    <input class="form-control input-sm-2" type="number" placeholder="Enter Value"  value="{{ $quantity[$key] }}"
                                                    wire:model="quantity.{{ $key }}" wire:input="changeQuantity({{$key}})">
                                                    <span class="input-group-text input-sm-2">{{ getUnitType($material_unit[$key]) }}</span>
                                                </div>
                                            </td>
                                            <td class="w-table-20">
                                                <a href="#" class="text-danger" type="button" wire:click.prevent="delete({{$key}})"><i class="fa fa-times"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                ...
                                <div class="row g-3 mb-0 align-items-center justify-content-between">
                                    ...
                                    <div class="col-lg-4 col-12">
                                        <div class="row align-items-center gx-3">
                                            <div class="col-6">
                                                <button class="btn btn-secondary w-100" type="reset" wire:click.prevent="$emit('reloadpage')">{{ __('main.clear_all') }}</button>
                                            </div>
                                            <div class="col-6">
                                                <button class="btn btn-primary w-100" type="submit" wire:click.prevent="save">{{__('main.submit')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
