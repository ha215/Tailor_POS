        ...
        <div class="row">
            <div class="col-12">
                <h5 class="fw-500 text-center text-dark">
                    {{ $lang->data['sales_return_report'] ?? 'Sales Return Report' }}</h5>
                    ...
                    <div class="card-body p-0">
                                ...
                                <tbody>
                                    @foreach ($salesreturns as $item)
                                        <tr class="tag-text">
                                            ...
                                            <td>#{{ $item->sales_return_number }}</td>
                                            <td>
                        ...
                        <div class="card-footer py-3">
                            <div class="row g-3 align-items-center justify-content-between">
                                <div class="col-2">
                                    <div class="">
                                        <div class="fw-bold text-xs">Total Sales Returns:</div>
                                        <div class="fw-bold text-xs">{{ $salesreturns->count() }}</div>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="">
                                        <div class="fw-bold text-xs">Total Returns:</div>
                                ...
                                <div class="col-2">
                                    <div class="">
                                        ...
                                        <div class="fw-bold text-xs">
                                            {{ getFormattedCurrency($salesreturns->sum('discount')) }}</div>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="">
