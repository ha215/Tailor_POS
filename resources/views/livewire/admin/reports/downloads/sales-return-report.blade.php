<div>
    ...
    <body onload="">
        ...
        @endphp
        <h3 class="fw-500 text-dark">Sales Return Report</h3>
        @if($branch != '')
           @php
        ...
        <table id="main" width="100%" cellpadding="0" cellspacing="0">
            <thead>
                <tr class="table-dark">
                    ...
                    <th class="text-primary"  scope="col">Sales Return #</th>
                    <th class="text-primary"  scope="col">Customer</th>
                    <th class="text-primary"  scope="col">Taxable Amount</th>
                    <th class="text-primary"  scope="col">Discount</th>
                    <th class="text-primary"  scope="col">Tax Amount</th>
                    <th class="text-primary"  scope="col">Gross Total</th>
                    <th class="text-primary"  scope="col">Branch</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="tag-text">
                    ...
                    <td class="w-table-10">#{{$item->sales_return_number}}</td>
                    <td class="w-table-20">
        ...
        <table cellspacing="15">
            <tr>
                <td class="col">
                    <span class="text-sm mb-0 fw-500">Total Sales Returns:</span>
                    <span class="text-sm text-dark ms-2 fw-600 mb-0">{{$invoices->count()}}</span>
                </td>
                <td class="col"> <span class="text-sm mb-0 fw-500">Total Returns:</span>
                    <span
