                        ...
                        <div class="card-header">
                            <div class="row gx-3 mb-0">
                                <div class="col-12 mb-4">
                                    <h5 class="mb-0">{{ __('main.sales_return_report') }}
                                    </h5>
                                </div>
                                <div class="col-3">
                                    <div class="mb-0">
                        ...
                        <div class="card-footer py-3">
                            <div class="row g-3 align-items-center justify-content-between">
                                <div class="col-lg-2 col-12">
                                    <div class="">
                                        <div class="fw-bold">
                                            {{ __('main.total_sales_return') }}:</div>
                                        <div class="fw-bold">{{ $salesreturns->count() }}</div>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-12">
                                    <div class="">
                                        <div class="fw-bold">{{ __('main.total_returns') }}:</div>
                                        <div class="fw-bold">
                                            {{ getFormattedCurrency($salesreturns->sum('total') ?? 0) }}</div>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-12">
                                    <div class="">
                                        ...
                                        <div class="fw-bold">{{ getFormattedCurrency($salesreturns->sum('discount')) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-12">
                                    <div class="">
                                        ...
                                        <div class="fw-bold">
                                            {{ getFormattedCurrency($salesreturns->sum('tax_amount')) }}</div>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <button class="btn btn-secondary me-2" type="button"
                                        wire:click="downloadFile()">{{ __('main.download_report') }}</button>
                                    <a href="{{ url('admin/reports/print/sales-return/' . $start_date . '/' . $end_date . '/' . $branch) }}"
