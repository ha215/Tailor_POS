                        ...
                        <div class="card-header">
                            <div class="row gx-3 mb-0">
                                <div class="col-12 mb-4">
                                    <h5 class="mb-0">{{ __('main.staff_report') }}</h5>
                                </div>
                                <div class="col-3">
                                    <div class="mb-0">
                                ...
                                @endif
                                    <div class="col-3">
                                        <div class="mb-0">
                                            <label class="form-label">{{ __('main.staffs') }}</label>
                                            <select required class="form-select" wire:model="staff">
                                                <option value="">
                                                    {{ __('main.all_staff') }}</option>
                        ...
                        <div class="card-footer py-3">
                            <div class="row g-3 align-items-center justify-content-between">
                                ...
                                <div class="col-auto">
                                    ...
                                    <a href="{{ url('admin/reports/print/staff/' . $start_date . '/' . $end_date . '/' . ($staff ?? 'all')) }}"
