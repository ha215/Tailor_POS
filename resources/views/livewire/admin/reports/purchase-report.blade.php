                        ...
                        <div class="card-header">
                            <div class="row gx-3 mb-0">
                                <div class="col-12 mb-4">
                                    <h5 class="mb-0">{{ __('main.purchase_report') }}</h5>
                                </div>
                                <div class="col-3">
                                    <div class="mb-0">
                        ...
                        <div class="table-responsive mt-0">
                            <table class="table table-bordered">
                                <thead class="bg-light text-xs">
                                    ...
                                    <th class="text-primary w-table-18" scope="col">
                                ...
                                <tbody>
                                    @foreach ($purchases as $item)
                                        <tr class="tag-text">
                                            ...
                                            <td class="w-table-12">{{ getFormattedCurrency($item->discount) }}</td>
                                            <td class="w-table-15">{{ getFormattedCurrency($item->tax_amount) }}</td>
                                            <td class="w-table-10">{{ getFormattedCurrency($item->total) }}</td>
                        ...
                        <div class="card-footer py-3">
                            <div class="row g-3 align-items-center justify-content-between">
                                <div class="col-lg-2 col-12">
                                    <div class="">
                                        <div class="fw-bold">{{ __('main.total_purchases') }}:
                                        </div>
                                        <div class="fw-bold">{{ $purchases->count() }}</div>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-12">
                                    <div class="">
                                        <div class="fw-bold">{{ __('main.total_amount') }}:</div>
                                        <div class="fw-bold">{{ getFormattedCurrency($purchases->sum('total')) }}</div>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-12">
                                    <div class="">
                                        ...
                                        <div class="fw-bold">{{ getFormattedCurrency($purchases->sum('discount')) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-12">
                                    <div class="">
                                        ...
                                        <div class="fw-bold">{{ getFormattedCurrency($purchases->sum('tax_amount')) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    ...
                                    <a href="{{ url('admin/reports/print/purchase/' . $start_date . '/' . $end_date) }}"
