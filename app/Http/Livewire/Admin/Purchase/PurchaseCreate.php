...
class PurchaseCreate extends Component
{
    ...
    // Initializes the component, setting the default language and purchase date.
    public function mount(){
        $this->purchase_date=\Carbon\Carbon::now()->toDateString();
    }
    ...
    public function addSupplier()
    {
        ...
        $this->resetFields();
        $this->selectSupplier($newSupplier->id);
    ...
    public function rowCalculation($id) {
        $this->tax_amount[$id] = $this->price[$id] * $this->quantity[$id] * (getTaxPercentage()/100) ;
    ...
    public function finalCalculation(){
        ...
        foreach($this->inputs as $key => $value) {
            $tax_amount_current = (($this->price[$key] * $this->quantity[$key]) * (getTaxPercentage()/100));
    ...
    public function calculation(){
        ...
        if($supplier_test) {
            ...
            $purchase->tax_percentage = getTaxPercentage();
