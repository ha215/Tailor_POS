...
class PrintStaffReport extends Component
{
    public $branches, $branch, $start_date, $end_date, $invoices, $staff;
    public function render()
    {
        return view('livewire.admin.reports.prints.print-staff-report')->extends('layouts.print-layout')
            ->section('content');
    }

    //apply filters and load content for print
    public function mount($start_date, $end_date, $staff = null)
    {
